...
#define DEFAULT_INPUT_IMAGE           RESOURCE_DIR"/face_01.jpg"
...
int32_t main(int argc, char* argv[])
{
    ...
    cv::Mat eye_image = cv::imread("/home/dragon/FaceMesh/Selfie/selfie_sticker/data/emoji_scuba.png", cv::IMREAD_UNCHANGED);
    ...
    for (frame_cnt = 0; cap.isOpened() || frame_cnt < LOOP_NUM_FOR_TIME_MEASUREMENT; frame_cnt++) {
        ...
        // cv::imwrite("result_facemesh.jpg",image);
