...
public:
    ...
    int32_t Process(const cv::Mat& eye_image,const cv::Mat& original_mat, const std::vector<BoundingBox>& bbox_list, std::vector<Result>& result_list);
...
private:
    ...
    SelfieSticker::EyeSticker *eye_sticker;
};
